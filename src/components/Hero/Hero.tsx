...
const Hero: React.FC = () => {
  ...
  const phrases = ["a Web Developer", "a Problem Solver", "a Tech Enthusiast"]; 
  ...
  return (
    <>
      <div
        className="min-h-[calc(100vh-4rem)] flex items-center justify-center scroll-mt-16"
        id="hero"
      > 
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-75 p-4">
          <div className="bg-white dark:bg-gray-800 rounded-lg w-full max-w-4xl h-[80vh] flex flex-col">
            ...
            <div className="flex-grow p-1">
              <iframe 
                src="/assets/Christian_Harris_Resume.pdf#toolbar=0&navpanes=0&scrollbar=0" 
            ...
            <div className="p-4 border-t flex justify-end space-x-4">
              <a 
                href="/assets/Christian_Harris_Resume.pdf" 
                download 
